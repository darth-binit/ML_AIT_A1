...
if select == 'Predictive Analytics':
    ...
    with colp1:
        ...
        st.markdown(f"""<div style='background-color:#c1d6c1 ; padding: 55px; border-radius: 3px'>
                                                        ...
                                                        <p style='font-size: 13px; text-align: center'> This is Regression machine learning model, where model has been trained based 
                                                          on used car data set that has been sold. Please fill out the all the value for field as given to the right. Incase of value not 
                                                            being available, we will set a default value based on our dataset distribution. Where ever you see feature name followed by
                                                              ...
                                                              given by the user and then press enter. Finally when all the value is being entered, kindly press predict button to get selling price</p></div>""",
                                        unsafe_allow_html=True)
    ...
    if predict_btn:
        ...
        print(formatted_val)
        st.session_state['prediction_result'] = f"{formatted_val}"
